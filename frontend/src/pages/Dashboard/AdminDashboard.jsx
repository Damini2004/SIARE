        ...
        "
          ...
          "
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-[10px] font-semibold text-[#94a3b8] mt-1 truncate">
                      {box.label}
                    </p>
                  </div>
                </button>
                  ...
                  {membersLoading ? (
                    ...
                    members.map((member) => (
                      <tr key={member.id} className="hover:bg-[#fbfcfe]">
                        ...
                        <td className="px-6 py-4">
                          <span className="px-3 py-1 rounded-full bg-green-50 text-green-700 text-[11px] font-black uppercase">
